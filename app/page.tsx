...
import { checkUrl } from "../service/vidService";
    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl z-10">
        ...
        <section className="mt-16 text-center w-full max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-8">Why Use UltimateVid?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <article className="bg-white/5 backdrop-blur p-6 rounded-2xl border border-white/10 hover:bg-white/10 transition duration-300">
              <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">⚡</div>
              <h3 className="text-lg font-semibold text-green-400 mb-3">Lightning Fast</h3>
              <p className="text-gray-400 text-sm">Our optimized engine processes videos from Twitch, Bilibili, and others in seconds.</p>
            </article>
            <article className="bg-white/5 backdrop-blur p-6 rounded-2xl border border-white/10 hover:bg-white/10 transition duration-300">
              <div className="w-12 h-12 bg-blue-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">🎬</div>
              <h3 className="text-lg font-semibold text-blue-400 mb-3">Universal Support</h3>
              <p className="text-gray-400 text-sm">From Reddit threads to Vimeo showcases, we support nearly every video site.</p>
            </article>
            <article className="bg-white/5 backdrop-blur p-6 rounded-2xl border border-white/10 hover:bg-white/10 transition duration-300">
              <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">🔒</div>
              <h3 className="text-lg font-semibold text-purple-400 mb-3">Secure & Free</h3>
              <p className="text-gray-400 text-sm">No registration needed. SSL encrypted downloads for your privacy.</p>
            </article>
          </div>

          <div className="mt-16 pt-16 border-t border-white/10">
            <h3 className="text-xl font-semibold text-white mb-8">Supported Platforms</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 opacity-70">
              {['Twitch', 'Bilibili', 'Vimeo', 'Reddit', 'Dailymotion', 'YouTube', 'TikTok', 'Instagram', 'Facebook', 'Twitter/X', 'SoundCloud', 'Bandcamp'].map((platform) => (
                <div key={platform} className="p-3 bg-white/5 rounded-lg border border-white/5 text-sm md:text-base font-medium text-gray-300 hover:text-white hover:bg-white/10 transition cursor-default">
                  {platform}
                </div>
              ))}
            </div>
            <p className="mt-8 text-gray-500 text-sm">And 100+ other video streaming websites supported.</p>
          </div>
